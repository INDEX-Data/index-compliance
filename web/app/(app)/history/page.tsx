  ...
  return (
    <div className="p-8 max-w-6xl">
      <div className="flex items-start justify-between mb-8">
        <div>
          <h1 className="text-[24px] font-bold text-[#1c1d1f]" style={{ letterSpacing: '-0.02em' }}>Report History</h1>
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          {frameworkIds.map(fwId => {
            ...
            return (
              <div key={fwId} className="bg-white rounded-xl border border-[#e7e5e4] overflow-hidden shadow-card">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#f5f5f4]">
                      <th className="text-left px-5 py-3 text-[10px] font-semibold text-[#78716c] uppercase tracking-widest">Date</th>
                      <th className="text-left px-5 py-3 text-[10px] font-semibold text-[#78716c] uppercase tracking-widest">Score</th>
                      <th className="text-left px-5 py-3 text-[10px] font-semibold text-[#78716c] uppercase tracking-widest">Δ vs prev</th>
                      <th className="text-left px-5 py-3 text-[10px] font-semibold text-[#78716c] uppercase tracking-widest">Risk</th>
                      <th className="text-left px-5 py-3 text-[10px] font-semibold text-[#78716c] uppercase tracking-widest">Controls</th>
                          ...
                          <td className="px-5 py-3.5">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-[9px] text-[#d6d3d1] font-mono mt-0.5">{r.reportId}</div>
                              </div>
                            </div>
                          </td>
