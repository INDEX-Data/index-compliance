      ...
      <div className="w-full max-w-md">
        ...
        {phase === 'sign-in' && (
          <div className="bg-white rounded-2xl border border-[#e4e7ec] shadow-xl overflow-hidden">
            <div className="px-8 pt-8 pb-4 text-center border-b border-[#e4e7ec]">
              ...
              <h1 className="text-xl font-bold text-[#1c1d1f]">You've been invited</h1>
              {inviteEmail && (
                <p className="text-sm text-[#505967] mt-1">
                  This invite was sent to <strong className="text-[#1c1d1f]">{inviteEmail}</strong>
                </p>
              )}
        ...
        {(phase === 'ready' || phase === 'accepting') && (
          <div className="bg-white rounded-2xl border border-[#e4e7ec] shadow-xl p-8 text-center">
            ...
            <h1 className="text-xl font-bold text-[#1c1d1f] mb-2">Join as a team member</h1>
        ...
        {phase === 'done' && (
          <div className="bg-white rounded-2xl border border-[#e4e7ec] shadow-xl p-8 text-center">
            ...
            <h1 className="text-xl font-bold text-[#1c1d1f] mb-2">You're in!</h1>
            <p className="text-sm text-[#505967] mb-6">
        ...
        {phase === 'already' && (
          <div className="bg-white rounded-2xl border border-[#e4e7ec] shadow-xl p-8 text-center">
            ...
            <h1 className="text-xl font-bold text-[#1c1d1f] mb-2">Already a member</h1>
            <p className="text-sm text-[#505967] mb-6">
