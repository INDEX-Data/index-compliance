...
export const iso27001Controls: ComplianceControl[] = [
  ...
  auto(
    ...
    'Directory identities are uniquely provisioned and lifecycle-managed (joiner/mover/leaver process documented).',
    [users('a5_16')]
  ),
  auto(
    'A.5.17',
  ...
  auto(
    ...
    ORG,
    'evaluate_proxy_signal',
    'Cloud service acquisition, use, and exit processes are documented; posture tracking (Secure Score) supports them.',
    [secureScore('a5_23')]
  ),
  manual(
    'A.5.24',
  ...
  auto(
    ...
    PPL,
    'evaluate_proxy_signal',
    'Post-termination responsibilities are defined and communicated; leaver accounts are disabled in the directory.',
    [users('a6_5')]
  ),
  manual(
    'A.6.6',
  ...
  auto(
    ...
    TECH,
    'evaluate_device_av',
    'Device compliance policies require active antivirus/Defender protection on managed endpoints.',
    [deviceCompliance('a8_7'), secureScore('a8_7')]
  ),
  auto(
    'A.8.8',
  ...
  auto(
    ...
    'Microsoft 365 audit and sign-in timestamps are generated by Microsoft infrastructure in UTC from synchronized clocks.',
