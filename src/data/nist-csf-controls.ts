...
export const nistCsfControls: ComplianceControl[] = [
...

  {
    ...
    evaluationCriteria: {
      ...
      customEvaluator: 'evaluate_org_security_contacts',
    },
  },

  {
    ...
    description:
      'Legal, regulatory, and contractual cybersecurity obligations are understood and managed.',
    frameworkId: FRAMEWORK,
    family: 'Govern: Organizational Context',
    evidenceQueries: [
      {
...

  {
    ...
    description:
      'An organizational cybersecurity risk management strategy is established, communicated, and monitored.',
    frameworkId: FRAMEWORK,
    ...
    evidenceQueries: [
      {
        ...
        description:
          'Microsoft Secure Score — proxy for whether security posture is actively tracked',
...

  {
    ...
    description:
      'Risk tolerance and appetite are established and communicated for cybersecurity risk decisions.',
    frameworkId: FRAMEWORK,
    family: 'Govern: Risk Management',
    evidenceQueries: [
      {
        ...
        description:
          'Named / trusted locations defined in Conditional Access (reflects risk tolerance for network access)',
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Named locations and authentication strength policies define enforced risk boundaries',
      customEvaluator: 'evaluate_policy_exists',
    },
  },

  {
    ...
    description:
      'Roles and responsibilities for cybersecurity are established, communicated, and enforced.',
    frameworkId: FRAMEWORK,
...

  {
    ...
    description:
      'Cybersecurity policies that address purpose, scope, roles, responsibilities, and compliance are established and communicated.',
    frameworkId: FRAMEWORK,
...

  {
    ...
    description:
      'Cybersecurity risk management results are communicated and used to inform organizational priorities.',
    frameworkId: FRAMEWORK,
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Secure Score history shows active monitoring and improvement action updates',
      customEvaluator: 'evaluate_risk_assessment',
    },
  },
...

  {
    ...
    description:
      'External users, identities, and access are managed and limited to what is necessary.',
    frameworkId: FRAMEWORK,
    family: 'Identify: Asset Management',
    evidenceQueries: [
      {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'External guest accounts are limited and B2B collaboration is restricted to approved domains',
...

  {
    ...
    description:
      'Inventories of data and corresponding protection requirements are established and maintained.',
    frameworkId: FRAMEWORK,
    family: 'Identify: Asset Management',
    evidenceQueries: [
      {
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Security improvement actions are ranked by priority and remediation is available',
      customEvaluator: 'evaluate_risk_assessment',
    },
  },

  {
    ...
    description:
      'Improvements are identified from cybersecurity evaluations, assessments, and exercises.',
    frameworkId: FRAMEWORK,
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Passwordless-capable users exist and authentication strength policies are defined',
      customEvaluator: 'evaluate_mfa_coverage',
    },
  },

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Privileged role assignments follow least privilege with limited Global Admins',
      customEvaluator: 'evaluate_rbac',
    },
  },
    ...
    evidenceQueries: [
      {
        ...
        description:
          'Device compliance policies including encryption and physical security controls',
        endpoint: '/deviceManagement/deviceCompliancePolicies',
        method: 'GET',
        category: 'deviceCompliance',
        requiredPermissions: ['DeviceManagementConfiguration.Read.All'],
...

  {
    ...
    description:
      'Personnel receive awareness and training so they can perform their cybersecurity-related duties.',
    frameworkId: FRAMEWORK,
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Sensitivity labels and DLP policies are classifying and protecting sensitive data',
      customEvaluator: 'evaluate_sensitivity_labels',
    },
  },
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Device compliance policies and configuration profiles are established in Intune',
      customEvaluator: 'evaluate_configuration_management',
    },
  },

  {
    ...
    description:
      'Software is maintained to reduce known vulnerabilities through patching and updates.',
    frameworkId: FRAMEWORK,
    family: 'Protect: Platform Security',
    evidenceQueries: [
      {
...

  {
    ...
    description:
      'Installation and execution of unauthorized software is prevented; privileged access is controlled.',
    frameworkId: FRAMEWORK,
    family: 'Protect: Platform Security',
    evidenceQueries: [
      {
...

  {
    ...
    description:
      'Networks and environments are protected to support resilience against cybersecurity attacks.',
    frameworkId: FRAMEWORK,
...

  {
    ...
    description:
      'Networks, network services, and user activity are monitored to find potentially adverse events.',
    frameworkId: FRAMEWORK,
...

  {
    ...
    description:
      'Computing hardware, software, runtime environments, and their data are monitored.',
    frameworkId: FRAMEWORK,
    family: 'Detect: Continuous Monitoring',
    evidenceQueries: [
      {
...

  {
    ...
    description:
      "The organization's computing capabilities and the integrity of related systems are monitored.",
    frameworkId: FRAMEWORK,
    family: 'Detect: Continuous Monitoring',
    evidenceQueries: [
      {
...

  {
    ...
    description:
      'Potentially adverse events are analyzed to characterize them and detect cybersecurity incidents.',
    frameworkId: FRAMEWORK,
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Security alerts and identity risk detections are being generated and available for analysis',
      customEvaluator: 'evaluate_security_monitoring',
    },
  },

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'High-severity alerts and high-risk user accounts are identified for impact assessment',
      customEvaluator: 'evaluate_security_monitoring',
    },
  },
...

  {
    ...
    description:
      'Incidents are reported to designated internal and external stakeholders in a timely manner.',
    frameworkId: FRAMEWORK,
    family: 'Respond: Incident Management',
    evidenceQueries: [
      {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Security notification contacts are configured and resolved alerts demonstrate incident tracking',
      customEvaluator: 'evaluate_org_security_contacts',
    },
  },

  {
    ...
    description:
      'Root causes of incidents are analyzed to determine contributing factors and inform improvements.',
    frameworkId: FRAMEWORK,
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Risk detection details and audit logs provide root cause investigation capability',
      customEvaluator: 'evaluate_audit_logging',
    },
  },

  {
    ...
    description:
      'Response activities are coordinated with stakeholders via appropriate communication channels.',
    frameworkId: FRAMEWORK,
...

  {
    ...
    evidenceQueries: [
      ...
      },
      {
        ...
        description:
          'Conditional Access policies with risk-based conditions for automated containment',
        endpoint: '/identity/conditionalAccess/policies',
        method: 'GET',
        category: 'conditionalAccess',
        requiredPermissions: ['Policy.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Risk-based Conditional Access policies provide automated containment and risky users are being remediated',
      customEvaluator: 'evaluate_security_monitoring',
    },
  },
...

  {
    ...
    evidenceQueries: [
      ...
      },
      {
        ...
        description:
          'Conditional Access policies that can be disabled/enabled for incident response',
        endpoint: '/identity/conditionalAccess/policies',
        method: 'GET',
        category: 'conditionalAccess',
        requiredPermissions: ['Policy.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Organization and access policies are configured to support recovery operations',
      customEvaluator: 'evaluate_policy_exists',
    },
  },
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Resolved alerts and remediated risk events demonstrate completed recovery operations',
      customEvaluator: 'evaluate_security_monitoring',
    },
  },

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Recovery communication contacts are defined and audit trail supports reporting',
      customEvaluator: 'evaluate_org_security_contacts',
    },
  },
]
