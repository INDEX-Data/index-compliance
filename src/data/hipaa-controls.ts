// =============================================================================
// INDEX DSaaS â€” HIPAA Security Rule Controls
//
// 45 CFR Part 164, Subpart C â€” Security Standards for the Protection of
// Electronic Protected Health Information (ePHI)
//
// Organized by the three safeguard categories:
//   Â§ 164.308  Administrative Safeguards (12 controls)
//   Â§ 164.310  Physical Safeguards      (4 controls)
//   Â§ 164.312  Technical Safeguards     (5 controls)
//   Â§ 164.314  Organizational Requirements (1 control)
//
...
export const hipaaControls: ComplianceControl[] = [
  // ===========================================================================
  // ADMINISTRATIVE SAFEGUARDS â€” Â§ 164.308
  // ===========================================================================

  {
    ...
    title: 'Risk Analysis',
    description:
      'Conduct an accurate and thorough assessment of potential risks and vulnerabilities to the confidentiality, integrity, and availability of electronic protected health information (ePHI).',
    frameworkId: FW,
    family: 'Administrative Safeguards â€” Â§ 164.308',
    evidenceQueries: [
      {
        id: 'hipaa-308a1i-score',
        description: 'Microsoft Secure Score â€” overall security posture and risk indicators',
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Active risk monitoring (Secure Score) in place with no unaddressed high/critical identity risks',
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Risk mitigation controls (CA policies, device compliance, identity risk remediation) are active',
...

  {
    ...
    evidenceQueries: [
      {
        ...
        description:
          'Directory role assignments â€” identify Security Admin / Compliance Admin roles',
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Dedicated Security Admin or Compliance Admin role assignments exist and are not overly broad',
...

  {
    ...
    description:
      'Implement procedures for the authorization and supervision of workforce members who work with ePHI or in locations where it might be accessed.',
    frameworkId: FW,
    family: 'Administrative Safeguards â€” Â§ 164.308',
    evidenceQueries: [
      {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Role-based access controls limit ePHI access to authorized workforce members',
      customEvaluator: 'evaluate_rbac',
    },
  },

  {
    ...
    description:
      'Implement procedures for terminating access to ePHI when the employment or workforce arrangement ends.',
    frameworkId: FW,
    family: 'Administrative Safeguards â€” Â§ 164.308',
    evidenceQueries: [
      {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'User lifecycle events are audited; terminated user access is revoked promptly',
...

  {
    ...
    description:
      'Implement policies and procedures for granting access to ePHI â€” for example, through access to a workstation, transaction, program, or process.',
    frameworkId: FW,
    family: 'Administrative Safeguards â€” Â§ 164.308',
    evidenceQueries: [
      {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Formal access control policies (CA + RBAC) govern who can access ePHI-bearing systems',
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Device compliance policies require anti-malware; Defender alerting is active',
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Sign-in activity and risk events are monitored via Entra ID sign-in logs and Identity Protection',
...

  {
    ...
    evidenceQueries: [
      {
        ...
        description: 'MFA registration â€” strong authentication replacing weak passwords',
        endpoint: '/reports/authenticationMethods/userRegistrationDetails',
        method: 'GET',
        category: 'identityProtection',
        requiredPermissions: ['UserAuthenticationMethod.Read.All'],
      ...
      },
      {
        ...
        description: 'Authorization policy â€” password protection and banned passwords settings',
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'MFA is registered by all workforce members; password protection policies are in place',
...

  {
    ...
    description:
      'Implement policies and procedures to address security incidents, including identifying and responding to suspected or known security incidents.',
    frameworkId: FW,
    family: 'Administrative Safeguards â€” Â§ 164.308',
    evidenceQueries: [
      {
        id: 'hipaa-308a6i-alerts',
        description: 'Security alerts â€” active incidents requiring response',
        endpoint: '/security/alerts_v2',
        method: 'GET',
        category: 'identityProtection',
        requiredPermissions: ['SecurityEvents.Read.All'],
      ...
      },
      {
        ...
        description: 'Risky users â€” identity incidents requiring remediation',
        endpoint: '/identityProtection/riskyUsers',
        method: 'GET',
        category: 'identityProtection',
        requiredPermissions: ['IdentityRiskyUser.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Security alerting is active; open incidents are triaged; risky users are remediated',
      customEvaluator: 'evaluate_security_monitoring',
    },
  },

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'M365 retention policies or equivalent backup mechanisms preserve ePHI copies',
...

  {
    ...
    title: 'Evaluation',
    description:
      'Perform a periodic technical and nontechnical evaluation in response to environmental or operations changes affecting ePHI security.',
    frameworkId: FW,
    family: 'Administrative Safeguards â€” Â§ 164.308',
    evidenceQueries: [
      {
        id: 'hipaa-308a8-score',
        description: 'Secure Score â€” continuous security evaluation posture',
        endpoint: '/security/secureScores',
        method: 'GET',
        category: 'identityProtection',
        requiredPermissions: ['SecurityEvents.Read.All'],
      ...
      },
      {
        ...
        description: 'Secure Score control improvement actions â€” gaps to evaluate',
        endpoint: '/security/secureScoreControlProfiles',
        method: 'GET',
        category: 'identityProtection',
        requiredPermissions: ['SecurityEvents.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Ongoing security evaluation is supported by Secure Score tracking and control gap analysis',
      customEvaluator: 'evaluate_risk_assessment',
    },
  },

  // ===========================================================================
  // PHYSICAL SAFEGUARDS â€” Â§ 164.310
  // ===========================================================================

  {
    ...
    frameworkId: FW,
    family: 'Physical Safeguards â€” Â§ 164.310',
    evidenceQueries: [
      {
        id: 'hipaa-310a1-devicecompliance',
        description: 'Device compliance policies â€” physical device access requirements',
        endpoint: '/deviceManagement/deviceCompliancePolicies',
        method: 'GET',
        category: 'deviceCompliance',
        requiredPermissions: ['DeviceManagementConfiguration.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Device compliance policies and CA controls ensure only authorized endpoints access ePHI systems',
      customEvaluator: 'evaluate_device_compliance',
    },
  },

  {
    ...
    description:
      'Implement policies and procedures that specify the proper functions to be performed, the manner in which those functions are to be performed, and the physical attributes of the surroundings of a specific workstation that can access ePHI.',
    frameworkId: FW,
    family: 'Physical Safeguards â€” Â§ 164.310',
    evidenceQueries: [
      {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Intune configuration profiles define and enforce proper workstation use policies',
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Workstations are managed by Intune with encryption and screen-lock policies enforced',
      customEvaluator: 'evaluate_device_compliance',
    },
  },

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Device configurations restrict removable media; DLP policies prevent unauthorized ePHI export',
      customEvaluator: 'evaluate_configuration_management',
    },
  },

  // ===========================================================================
  // TECHNICAL SAFEGUARDS â€” Â§ 164.312
  // ===========================================================================

  {
    ...
    frameworkId: FW,
    family: 'Technical Safeguards â€” Â§ 164.312',
    evidenceQueries: [
      {
        id: 'hipaa-312a1-ca',
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'CA policies + MFA + RBAC restrict access to ePHI systems to authorized personnel only',
      customEvaluator: 'evaluate_mfa_enforcement',
    },
  },

  {
    ...
    evidenceQueries: [
      {
        ...
        description: 'Directory audit logs â€” user and admin activity on ePHI systems',
        endpoint: '/auditLogs/directoryAudits',
        method: 'GET',
        category: 'auditLog',
        requiredPermissions: ['AuditLog.Read.All'],
      ...
      },
      {
        ...
        description: 'Sign-in logs â€” access to ePHI systems',
        endpoint: '/auditLogs/signIns',
        method: 'GET',
        category: 'auditLog',
        requiredPermissions: ['AuditLog.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Unified audit logging captures user activity, sign-ins, and admin operations across ePHI systems',
      customEvaluator: 'evaluate_audit_logging',
    },
  },

  {
    ...
    evidenceQueries: [
      ...
      },
      {
        ...
        description: 'Secure Score â€” data integrity control signals',
        endpoint: '/security/secureScores',
        method: 'GET',
        category: 'identityProtection',
        requiredPermissions: ['SecurityEvents.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Information protection policies (sensitivity labels, DLP) prevent unauthorized modification of ePHI',
...

  {
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'MFA is enforced for all users accessing ePHI via Conditional Access and authentication policies',
      customEvaluator: 'evaluate_mfa_coverage',
    },
  },

  {
    ...
    evidenceQueries: [
      {
        ...
        description:
          'CA policies requiring compliant/managed devices (enforces secure transmission paths)',
        endpoint: '/identity/conditionalAccess/policies',
        method: 'GET',
        category: 'conditionalAccess',
        requiredPermissions: ['Policy.Read.All'],
      },
      {
        ...
        description: 'Secure Score â€” TLS / encryption-at-rest and in-transit signals',
        endpoint: '/security/secureScores',
        method: 'GET',
        category: 'identityProtection',
        requiredPermissions: ['SecurityEvents.Read.All'],
      ...
      {
        id: 'hipaa-312e1-dlp',
        description: 'DLP audit events â€” protecting ePHI from unauthorized transmission',
        endpoint: '/auditLogs/directoryAudits',
        method: 'GET',
        category: 'auditLog',
        requiredPermissions: ['AuditLog.Read.All'],
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'Conditional Access enforces compliant device access; DLP guards against unauthorized ePHI transmission',
      customEvaluator: 'evaluate_dlp_policies',
    },
  },

  // ===========================================================================
  // ORGANIZATIONAL REQUIREMENTS â€” Â§ 164.314
  // ===========================================================================

  {
    ...
    description:
      'A covered entity may not permit a business associate to create, receive, maintain, or transmit ePHI on its behalf without entering into a satisfactory business associate contract.',
    frameworkId: FW,
    family: 'Organizational Requirements â€” Â§ 164.314',
    evidenceQueries: [
      {
        id: 'hipaa-314a1-guests',
        description:
          'External/guest user accounts (potential business associates with tenant access)',
        endpoint: '/users',
        method: 'GET',
        category: 'identityProtection',
    ...
    evaluationCriteria: {
      type: 'custom',
      passingCondition:
        'External access is restricted; guest accounts are limited and governed by restrictive invitation policy',
